...
/*
 * This file is included by 'salsa20-portable.h'. It allows to override
...
#if (defined(SALSA20_DEFAULT_ROT) && !defined(SALSA20_MACHINE_ROT))

#define SALSA20_MACHINE_ROT
...
#if (defined(SALSA20_DEFAULT_SWAP) && !defined(SALSA20_MACHINE_SWAP))

#define SALSA20_MACHINE_SWAP
